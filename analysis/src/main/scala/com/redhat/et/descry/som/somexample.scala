...
object Example {
  ...
  def apply(xdim: Int, ydim: Int, iterations: Int, sc: SparkContext): SOM = {
    val rnd = new scala.util.Random()
    val colors = Array.fill(200000)(new DV(Array.fill(3)(rnd.nextDouble)).compressed)
    ...
    com.redhat.et.descry.som.SOM.train(xdim, ydim, 3, iterations, examples, hook=writeStep _)
  }
